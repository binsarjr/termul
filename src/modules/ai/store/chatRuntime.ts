...
// Chat construction lives here, split out of chatStore, because its graph
// (transport → agent → tools → zod, plus the AI SDK runtime) is heavy.
// chatStore stays in the startup bundle; this module must only ever be
// reached from lazy AI components or via dynamic import().
