...
export const SETTINGS_INDEX: SettingsSearchEntry[] = [
  ...
  {
    id: "tab-name-active-pane",
    section: "general",
    group: "Tabs",
    label: "Name tabs from active pane",
    description: "Auto-name a terminal tab after its focused pane.",
    keywords: ["tab name", "auto name", "active pane", "rename tab", "tab title"],
  },
  {
    id: "tab-ssh-badge",
    section: "general",
    group: "Tabs",
    label: "Show SSH host badge",
    description: "Badge a terminal tab with its SSH host.",
    keywords: ["ssh badge", "host badge", "ssh", "tab badge"],
  },
  {
    id: "truncate-tab-titles",
    section: "general",
    group: "Tabs",
    label: "Truncate long tab titles",
    description: "Cut long tab names with an ellipsis.",
    keywords: ["truncate", "ellipsis", "tab title", "long names", "tab strip"],
  },
  {
    id: "tab-bar-position",
    section: "general",
    ...
    description: "Show tabs across the top or as a column on the left.",
    keywords: ["tab bar", "tab position", "vertical tabs", "left tabs", "sidebar tabs"],
  },
  {
